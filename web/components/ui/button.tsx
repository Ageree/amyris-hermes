...
const variants: Record<Variant, string> = {
  primary:
    "bg-lime text-canvas font-medium shadow-[0_1px_0_0_rgba(255,255,255,0.35)_inset,0_8px_24px_-8px_rgba(214,255,63,0.55)] hover:bg-lime-dim hover:shadow-[0_1px_0_0_rgba(255,255,255,0.4)_inset,0_10px_30px_-6px_rgba(214,255,63,0.68)] hover:-translate-y-px active:translate-y-0",
  secondary:
