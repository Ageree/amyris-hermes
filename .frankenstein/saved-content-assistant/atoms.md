...
Base model: MiniMax M2.7 (model-agnostic architecture). Tools: Composio.
...
| 9 | LLM routing & cost | MiniMax M2.7 base via OpenAI-compatible endpoint; Gemini Flash fallback for video; per-user budgets |
...
- Wave 2 (done 2026-06-07): iMessage bridges, downloaders, MiniMax M2.7 verification,
